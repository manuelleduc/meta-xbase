 ...
 */
package fr.mleduc.xtext.xbase.specialized.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import fr.mleduc.xtext.xbase.specialized.ide.contentassist.antlr.internal.InternalXbaseSpecializedParser;
import fr.mleduc.xtext.xbase.specialized.services.XbaseSpecializedGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class XbaseSpecializedParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(XbaseSpecializedGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XbaseSpecializedGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getXExpressionAccess().getAlternatives(), "rule__XExpression__Alternatives");
			...
			builder.put(grammarAccess.getXExpressionAccess().getGroup_1(), "rule__XExpression__Group_1__0");
			...
			builder.put(grammarAccess.getModelAccess().getExpressionsAssignment_1(), "rule__Model__ExpressionsAssignment_1");
			builder.put(grammarAccess.getXExpressionAccess().getExpressionAssignment_1_2(), "rule__XExpression__ExpressionAssignment_1_2");
	...
	@Override
	protected InternalXbaseSpecializedParser createParser() {
		InternalXbaseSpecializedParser result = new InternalXbaseSpecializedParser(null);
