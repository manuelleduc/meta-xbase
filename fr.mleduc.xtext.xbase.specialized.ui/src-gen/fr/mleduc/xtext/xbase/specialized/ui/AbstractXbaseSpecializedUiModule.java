...
import fr.mleduc.xtext.xbase.specialized.ide.contentassist.antlr.PartialXbaseSpecializedContentAssistParser;
import fr.mleduc.xtext.xbase.specialized.ide.contentassist.antlr.XbaseSpecializedParser;
import fr.mleduc.xtext.xbase.specialized.ide.contentassist.antlr.internal.InternalXbaseSpecializedLexer;
import fr.mleduc.xtext.xbase.specialized.ui.contentassist.XbaseSpecializedProposalProvider;
import fr.mleduc.xtext.xbase.specialized.ui.editor.XbaseSpecializedEditor;
import fr.mleduc.xtext.xbase.specialized.ui.labeling.XbaseSpecializedDescriptionLabelProvider;
import fr.mleduc.xtext.xbase.specialized.ui.labeling.XbaseSpecializedLabelProvider;
import fr.mleduc.xtext.xbase.specialized.ui.outline.XbaseSpecializedOutlineTreeProvider;
import fr.mleduc.xtext.xbase.specialized.ui.quickfix.XbaseSpecializedQuickfixProvider;
import fr.mleduc.xtext.xbase.specialized.validation.XbaseSpecializedValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link XbaseSpecializedUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractXbaseSpecializedUiModule extends DefaultXbaseUiModule {

	public AbstractXbaseSpecializedUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalXbaseSpecializedLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(fr.mleduc.xtext.xbase.specialized.parser.antlr.internal.InternalXbaseSpecializedLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return XbaseSpecializedParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalXbaseSpecializedLexer.class).toProvider(LexerProvider.create(InternalXbaseSpecializedLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return XbaseSpecializedValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return XbaseSpecializedLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(XbaseSpecializedDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return XbaseSpecializedOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return XbaseSpecializedQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return XbaseSpecializedProposalProvider.class;
	}
	...
	public Class<? extends XtextEditor> bindXtextEditor() {
		return XbaseSpecializedEditor.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialXbaseSpecializedContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("XbaseSpecialized Compare");
	}
