...
public class XbaseSpecializedValidatorConfigurationBlock extends XbaseValidationConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(XbaseSpecializedConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("XbaseSpecialized");
		if (section == null) {
			return dialogSettings.addNewSection("XbaseSpecialized");
		}
		return section;
	}
}
