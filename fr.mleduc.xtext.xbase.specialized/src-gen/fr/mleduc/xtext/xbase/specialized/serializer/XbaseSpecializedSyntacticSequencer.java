...
public class XbaseSpecializedSyntacticSequencer extends AbstractSyntacticSequencer {

	protected XbaseSpecializedGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (XbaseSpecializedGrammarAccess) access;
	 ...
	 *     (rule start) (ambiguity) 'down' expression=XExpression
